...
@Configuration
@EnableJpaRepositories(basePackages = {"com.bbpet.repos"})
@EnableTransactionManagement
@ComponentScan(basePackages = {"com.bbpet.repos", "com.bbpet.services"})
public class TransactionCfg {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.bbpet.domain");
